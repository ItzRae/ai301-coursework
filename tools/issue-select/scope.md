...
I’m a recent Computer Science graduate with experience in Python, Java, JavaScript/TypeScript, SQL, React, Vue, FastAPI, PostgreSQL, and REST APIs. I’m most comfortable with backend and full-stack work, including APIs, data pipelines, database-backed applications, and smaller frontend changes. I’m especially interested in getting better at production software engineering, debugging unfamiliar codebases, testing, and AI/LLM-related tooling. I’d prefer issues with a reasonably scoped implementation path and would avoid work that depends heavily on advanced DevOps, Kubernetes, low-level systems programming, or a framework/language I have not used before.